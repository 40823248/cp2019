...
(function dartProgram() {
  ...
  X = {
    main: function() {
      var angle, i, t2, toX, toY,
        t1 = H.interceptedTypeCheck(document.querySelector("#canvas"), "$isCanvasElement");
      $.canvas = t1;
      t1 = H.interceptedTypeCheck((t1 && C.CanvasElement_methods).getContext$1(t1, "2d"), "$isCanvasRenderingContext2D");
      $.ctx = t1;
  ...
  (function inheritance() {
    ...
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString, W.EventTarget, W.CanvasRenderingContext2D, W.DomException]);
...
//# sourceMappingURL=rocflag.js.map
