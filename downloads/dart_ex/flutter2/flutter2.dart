...
*/
  @override
  // build 方法傳回的物件資料型別為 Widget, 輸入為 context
  Widget build(BuildContext context) {
  // 傳回一個訂製的 MaterialApp 物件
    return MaterialApp(
    // 此 MaterialApp 中只宣告一個 title 與 home, 而 home 中則實現一個 Scaffold 物件
    // 而此 Scaffold 則帶有 appBar 與 body 等兩個屬性定義.
      title: 'Hi Reddit',
    ...
    // Scaffold() 是一個基本視覺布局架構部件, 提供 drawers, snack bars, and bottom sheets 等部件的架構設定
      home: Scaffold(
        ...
        // body 欄位使用 Center() 部件, 而 Center 則只有一個 child 欄位設定
        body: Center(
          child: Column(
